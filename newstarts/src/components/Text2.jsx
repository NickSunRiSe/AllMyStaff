  ...
  return (
    <div className={classes.teht}>
      ...
      <div className="logosfoto">
        <div className="logos">
        <a href={props.post.spotify} className="links" target="_blank" rel="noopener noreferrer">
  <FontAwesomeIcon icon={faSpotify} size='4x' />
</a>
<a href={props.post.Vk} className="links" target="_blank" rel="noopener noreferrer">
  <FontAwesomeIcon icon={faVk} size='4x' />
</a>
<a href={props.post.Yandex} className="links" target="_blank" rel="noopener noreferrer">
  <FontAwesomeIcon icon={faYandex} size='4x' />
</a>
<a href={props.post.Apple} className="links" target="_blank" rel="noopener noreferrer">
