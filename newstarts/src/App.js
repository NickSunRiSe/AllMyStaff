...
function App() {
  const [posts, setPosts] = useState ([
    ...
    {id: 3, title:'Грустные песни о успехах моей жизни', body:'Альбом который на данный момент является самым большим во всей дискрографии Истень по количеству треков', picture: <Foto/> },
  ])
  const [singles, setSingles] = useState([
    {Name: "Страшный сон", body: "Трек который потом вышел как альбом", picture: <Foto/>}
  ]
  )
